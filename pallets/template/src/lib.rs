...
pub mod pallet {
	...
	use frame_support::{
		pallet_prelude::*,
		traits::{Currency, ExistenceRequirement::KeepAlive, ExistenceRequirement::AllowDeath},
	};
	use frame_system::pallet_prelude::*;
	use frame_support::sp_runtime::{AccountId32, codec::{Encode, Decode}};
	use frame_support::weights::Weight;
	use log::{trace, debug, info, warn, error};
	use sp_core::crypto::Ss58Codec;
	//use frame_support::sp_core::crypto::Ss58Codec;
	pub const LOG_TARGET: &str = "my-pallet";
